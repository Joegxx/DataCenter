...
<head>
    ...
    <script type="text/javascript">
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.status === 200) {
                        ...
                        $('#carave').treegrid({
                            url: 'auction/bidave.do?session=all',
                            idField: 'id',
                            treeField: 'cityName',
                            columns: [[
        ...
        function myReload() {
            ...
            $("#carave").treegrid('options').url = 'auction/bidave.do';
...
<div id="datagridsearch" class="datagridsearch">
    <div style="height:30px;border-bottom: 1px solid #CCCCCC;padding: 5px;">
        ...
        <a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-reload'" style="width:80px"
           onclick="myReload()">请刷新</a>
    </div>
