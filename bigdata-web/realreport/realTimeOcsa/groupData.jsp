...
<body>
    <br>
    <b style="margin-left: 20px">分组数据</b>
    <span style="float:right; margin-right: 80px" >
        数据更新时间：<span id="updateTime"></span>
        <a href=" javascript:void(0)" onclick="refresh()">[刷新]</a>
    </span>
    <div style="margin:20px 0;"></div>
    <table id="report1" title="分组数据 - 1" class="easyui-treegrid" style="width:1250px;height:300px"
           data-options="
                url: 'realTimeOcsa/groupDataT1.do',
                method: 'get',
                rownumbers: true,
                showFooter: true,
                idField: 'id',
    ...
    <div style="margin:20px 0;"></div>
    <table id="report2" title="分组数据 - 2" class="easyui-treegrid" style="width:1250px;height:300px"
           data-options="
                url: 'realTimeOcsa/groupDataT2.do',
                method: 'get',
                rownumbers: true,
                showFooter: true,
                idField: 'id',
