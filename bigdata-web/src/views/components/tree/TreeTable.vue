        ...
        <el-table v-if="!loading"
            ...
            <el-table-column v-for="(column, index) of columns" :key="column.key"
                ...
                <span v-if="spaceIconShow(index)" v-for="(space, levelIndex) of scope.row._level" class="ms-tree-space"
                    ...
                    <tree-column :row="scope.row" :column="column" :col-index="index"></tree-column>
                </template>
            </el-table-column>
        ...
        computed: {
            ...
            data: function () {
                ...
                if (this.treeStructure) {
                    return Utils.treeToArray(me.dataSource, null, null, me.defaultExpandAll);
                }
