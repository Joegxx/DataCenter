    ...
    export default {
        ...
        methods: {
            ...
            handleSearch() {
                ...
                this.midTableData = this.value.filter(item => {
                    if (!this.searchValue || this.searchValue === '') {
                        return true
                    }
                    return (item[this.searchKey] + "") === (this.searchValue + "")
                });
                this.handleTableData()

            },
            handleTableData() {
                let len = this.midTableData.length;
            ...
            changePage(num) {
                ...
                let end = num * this.pageSize - 1;
                this.insideTableData = this.midTableData.slice(start, end).map((item, index) => {
                    let res = item;
